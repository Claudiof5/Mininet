...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', type=str, default="flow", help='Method for the message')
    parser.add_argument('--sensor', type=str, default="temp", help='Sensor type for the message')
    parser.add_argument('--collect', type=int, default=10, help='Collect time')
